...
<body class="nav-md">
                    ...
                    <div class="row x_panel">
                        <div class="">
                            <div class="x_title row justify-content-end">
                                <button type="button" class="btn btn-success" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="fa fa-plus"></i> Ajouter un client</button>
                            </div>
    ...
    <div class="modal fade bs-example-modal-lg" id="bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="" id="form_client" method="post">
                    <div class="field item form-group">
                        <label class="col-form-label col-md-3 col-sm-3  label-align">Nom client<span>*</span></label>
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" name="nameClient" id="nameClient" placeholder=""/>
                        </div>
                    </div>
                    <div class="field item form-group">
                        <label class="col-form-label col-md-3 col-sm-3  label-align">Telephone  <span class="required"></span></label>
                        <div class="col-md-6 col-sm-6">
                            <input type="text" class="form-control" name="phoneClient" id="phoneClient" placeholder="" />
                        </div>
                    </div>
                    <div class="ln_solid">
    ...
    <script src="<?= base_url()?>/GestionDepot/function/client/list.js"></script>
    <script src="<?= base_url()?>/GestionDepot/function/client/save.js"></script>
