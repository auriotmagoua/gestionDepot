...
<body class="nav-md">
                    ...
                    <div class="row x_panel">
                        <div class="">
                            <div class="x_title row justify-content-end">
                                <button type="button" class="btn btn-success" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="fa fa-plus"></i> Ajouter un utilisateur</button>
                            </div>
    ...
    <div class="modal fade bs-example-modal-lg" id="bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        ...
        <div class="modal-content">
            ...
            <h4 class="modal-title" id="myModalLabel">Enregistrer les utilisateurs</h4>
            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span>
            </button>
            </div>
            <div class="modal-body">
                <form class="" id="form_user" method="POST">
                    <!-- <hr> -->
                    <div class="field item form-group">
                        <label class="col-form-label col-md-3 col-sm-3  label-align">Login<span >*</span></label>
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" name="login2" id="login2" placeholder="" />
                        </div>
                    </div>
                    <div class="field item form-group">
                        <label class="col-form-label col-md-3 col-sm-3  label-align">Mot de passe <span class="required"></span></label>
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" name="password2" id="password2" placeholder="" />
                        </div>
                    </div>
                    <div class="ln_solid">
    ...
    <script src="<?= base_url()?>/GestionDepot/function/user/list.js"></script>
    <script src="<?= base_url()?>/GestionDepot/function/user/save.js"></script>
    <script>
